...
describe('favorite blog', () => {
  test('from list of blogs works', () => {
    const expected = {
      title: 'Canonical string reduction',
      author: 'Edsger W. Dijkstra',
      likes: 12
    }
    const result = listHelper.favorite(allBlogs)
    expect(result).toEqual(expected)
  })
  test('from empty list returns empty', () => {
    const result = listHelper.favorite([])
    expect(result).toEqual({})
  })
  test('from list with one entry works', () => {
    const expected = {
      title: 'Go To Statement Considered Harmful',
      author: 'Edsger W. Dijkstra',
      likes: 5,
    }
    const result = listHelper.favorite(oneBlog)
    expect(result).toEqual(expected)
  })
})
...
describe('most blogs by author', () => {
  ...
  test('from list with one entry works, returns 1 blog', () => {
    const expected = {
      author: 'Edsger W. Dijkstra',
      blogs: 1,
    }
